...
namespace LordKuper.OutfitManager.Patches
{
    ...
    internal static class JobGiverPatch
    {
        ...
        private static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            {
                new CodeInstruction(OpCodes.Ldloc_0), new CodeInstruction(OpCodes.Ldarg_0),
                new CodeInstruction(OpCodes.Ldarg_1),
                new CodeInstruction(CodeInstruction.Call(typeof(ApparelScoring),
                    nameof(ApparelScoring.GetPawnApparelWorkScore))),
                new CodeInstruction(OpCodes.Add), new CodeInstruction(OpCodes.Stloc_0)
            };
